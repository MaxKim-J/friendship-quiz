...
class Quiz(models.Model):
  ...
  option_1 = models.CharField(max_length=10, unique=False, verbose_name='선지1')
  option_2 = models.CharField(max_length=10, unique=False, verbose_name='선지2')
  option_3 = models.CharField(max_length=10, unique=False, verbose_name='선지3')
  option_4 = models.CharField(max_length=10, unique=False, verbose_name='선지4')
  option_5 = models.CharField(max_length=10, unique=False, verbose_name='선지5')
